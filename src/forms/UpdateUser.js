...
class UpdateUser extends Component {
    ...
    updateUser = async (dispatch, e) => {
        e.preventDefault();//default davranışları engeller //defult olarak submıte basıldıgında sayfanın yeniden yüklenmesini engeller
        //updateuser
                    ...
                    return (
                        <div className="col-md-8 mb-4" >
                            ...
                            <div className="card">
                                ...
                                {
                                     error ? <div className="aler alert-danger">
